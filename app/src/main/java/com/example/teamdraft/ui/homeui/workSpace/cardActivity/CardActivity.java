...
import com.example.teamdraft.ui.homeui.workSpace.cardActivity.attachments.AddAttachmentDialog;
import com.example.teamdraft.ui.homeui.workSpace.cardActivity.attachments.ItemAttachment;
import com.example.teamdraft.ui.homeui.workSpace.cardActivity.attachments.ItemAttachmentsAdapter;
import com.example.teamdraft.ui.homeui.workSpace.cardActivity.checkList.AddChecklistItemDialog;
import com.example.teamdraft.ui.homeui.workSpace.cardActivity.checkList.ItemChecklist;
import com.example.teamdraft.ui.homeui.workSpace.cardActivity.checkList.ItemChecklistAdapter;
import com.example.teamdraft.ui.homeui.workSpace.cardActivity.users.AddUserDialog;
import com.example.teamdraft.ui.homeui.workSpace.cardActivity.users.CardUsersAdapter;
...
public class CardActivity extends AppCompatActivity implements OnChange {
    String boardId, itemId, cardId;
    TextView cardTitle, description;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkListAdapter = new ItemChecklistAdapter(this, checkListItems, getSupportFragmentManager(), boardData, this);
    ...
    void getData() {
        ...
        mDatabase.child("boards").child(boardId).child("items").child(itemId).child("cards").child(cardId).addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
    ...
    @Override
    public void onCheckItemChecklist() {
        updateChecklistIndicators();
    }
